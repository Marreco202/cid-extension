// Este arquivo contém as definições de prompts do sistema em TypeScript

export const BASE_SYSTEM_FIRST_PROMPT = `
...
export const BASE_SYSTEM_SECOND_PROMPT = `
...
export const BASE_SYSTEM_THIRD_PROMPT = `
...
export const BASE_ADDITIONAL_SYSTEM_INSTRUCTIONS_PROMPT = `
...
export const BASE_SYSTEM_MODIFY_PROMPT = `
